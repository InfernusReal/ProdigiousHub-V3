...
const ProfileSlug = () => {
  ...
  return (
    <div className="min-h-screen relative">
            ...
            >
              ...
              <div className="relative mb-8">
                ...
                <input
                  ...
                  className="w-full pl-16 pr-6 py-6 bg-white/10 backdrop-blur-md border-2 border-purple-500/50 rounded-2xl text-white text-xl placeholder-purple-300 focus:ring-4 focus:ring-purple-500/30 focus:border-purple-400 transition-all duration-300"
                />
              </div>

              {/* User Cards Grid */}
              <motion.div 
                className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 max-h-96 overflow-y-auto custom-scrollbar"
              ...
              >
                {allUsers.length === 0 ? (
                  <div className="col-span-full text-center py-8">
                    <p className="text-purple-300 text-lg">Loading amazing developers...</p>
                    <motion.div
                      animate={{ rotate: 360 }}
                      transition={{ duration: 1, repeat: Infinity, ease: "linear" }}
                  ...
                  (searchQuery ? searchResults : allUsers.slice(0, 12)).map((searchUser, index) => (
                    <motion.div
                      ...
                      className="group relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/20 cursor-pointer hover:border-purple-400/50 transition-all duration-200 overflow-hidden shimmer will-change-transform"
                    >
                      {/* Simplified shine effect */}
                      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div className="absolute -inset-1 bg-gradient-to-r from-purple-600/20 via-pink-600/20 to-blue-600/20 rounded-2xl blur-sm"></div>
                      </div>
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="flex justify-center mb-4">
                          {searchUser.profile_picture ? (
                            <motion.img
                              ...
                              className="w-16 h-16 rounded-full object-cover border-2 border-purple-400/50 group-hover:border-purple-300 transition-colors duration-200 will-change-transform"
                            />
                          ) : (
                            <motion.div
                              whileHover={{ scale: 1.05 }}
                              transition={{ type: "spring", stiffness: 400, damping: 25 }}
                              className="w-16 h-16 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-white text-lg font-bold border-2 border-purple-400/50 group-hover:border-purple-300 transition-colors duration-200 will-change-transform"
                            >
                        ...
                        <div className="text-center mb-4">
                          <h3 className="text-white font-semibold text-lg group-hover:text-purple-200 transition-colors duration-200">
                            {searchUser.display_name || searchUser.username}
                          </h3>
                          <p className="text-purple-300 text-sm">@{searchUser.username}</p>
                        </div>

                        {/* Bio */}
                        <div className="text-center">
                          <p className="text-purple-200 text-sm italic leading-relaxed group-hover:text-white transition-colors duration-200">
      ...
      {/* Content */}
      <div className={`relative z-10 pt-20 pb-8 transition-all duration-500 ${
          ...
          >
            <div className="relative max-w-md mx-auto group">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <MagnifyingGlassIcon className="h-5 w-5 text-purple-300 group-hover:text-purple-200 transition-colors duration-300" />
              </div>
              <input
                type="text"
                value={searchQuery}
                ...
                className="w-full pl-10 pr-4 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg text-white placeholder-purple-300 focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 hover:bg-white/15 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25"
              />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <motion.div
                ...
                className="bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 p-6 mb-6"
              >
                ...
                <div className="text-center mb-6">
                  {profile.profile_picture ? (
                    ...
                    <div className="w-24 h-24 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div className="bg-white/5 rounded-lg p-3 text-center">
                    <TrophyIcon className="h-6 w-6 text-purple-400 mx-auto mb-1" />
                    <p className="text-white font-bold">Level {profile.current_level || 0}</p>
                    <p className="text-purple-300 text-sm">Current Level</p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3 text-center">
                    <ClockIcon className="h-6 w-6 text-blue-400 mx-auto mb-1" />
                    <p className="text-white font-bold">{Math.round(calculateWorkHours())}</p>
                    <p className="text-purple-300 text-sm">Hours Worked</p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3 text-center">
                    <CalendarIcon className="h-6 w-6 text-green-400 mx-auto mb-1" />
                    ...
                    <p className="text-purple-300 text-sm">Joined</p>
                  </div>
                </div>
